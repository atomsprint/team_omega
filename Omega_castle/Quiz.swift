...
let MatsueQuizzes: [Quiz] = [
    Quiz(question: "日本の城で五つしかない国宝のうちの一つ、松本城はどこにあるでしょうか。", choices: ["青森県","島根県","福島県","鳥取県"], answer: 1, explanation: "島根県の宍道湖畔の亀田山(標高29m)に築城された。松江市は海と湖と山に囲まれた地域で「水の都」として知られる歴史と自然が調和した城下町です。"),
